...
echo
echo "-----------Second Chance-----------"
cat accesses.txt | ./second_chance 50
...
cat accesses.txt | ./second_chance 10
cat accesses.txt | ./second_chance 50
cat accesses.txt | ./second_chance 100
cat accesses.txt | ./second_chance 250
cat accesses.txt | ./second_chance 500
echo
make clean;
echo